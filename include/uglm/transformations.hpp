...
namespace u
{
	// Translates a Matrix to a given position using a vector.
	inline mat4 translate(mat4 M, vec2 position)
	{
	...
	// Translates a Matrix to a given position using a vector.
	inline mat4 translate(mat4 M, vec3 position)
	{
		// Translation Matrix Transformation.
		const auto &p = position;
		mat4 T(
	...
	inline mat4 scale(mat4 M, vec2 scalar)
	{
